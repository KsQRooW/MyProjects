...
urlpatterns = [
    ...
    path('get_rectangle_area/<int:width>/<int:height>', views.redirect_function),
    path('get_square_area/<int:width>', views.redirect_function),
    path('get_circle_area/<int:radius>', views.redirect_function)
]
